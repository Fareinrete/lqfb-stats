...
directives.directive('graphactives', function() {
    return {
        restrict: 'E',
        scope: {
            valuesactivated: '='
...
directives.directive('graphactivations', function() {
    return {
        restrict: 'E',
        scope: {
            valuesactivations: '='
...
.directive('graphtllogin', function() {
    return {
        ...
        link: function(scope, element, attrs) {
            scope.$watch('valuestllogin', function(data) {
                if(data) {
                    console.log('values from directive: ', data);
                    var w = (document.documentElement.clientWidth / 100) * 88;
			var h = 150;
...
}).directive('adminactivated', function() {
    return {
        restrict: 'E',
        scope: {
            valuesadminactivated: '='
        },
        link: function(scope, element, attrs) {
            scope.$watch('valuesadminactivated', function(data) {
                if(data) {
                    console.log('values from directive: ', data);
                    //d3.select('svg').remove();
                    var width = (document.documentElement.clientWidth / 100) * 16,
